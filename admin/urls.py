...
urlpatterns = patterns('admin',
    ...
    (r'^sys/test/update_all_students/$', 'test_views.plan_update_all_students'),
    ...
    (r'^kurzy/(?P<course_id>\d+)/zaci/(?P<student_id>\d+)/change_qcard/$', 'student_views.change_qcard'),
    (r'^kurzy/(?P<course_id>\d+)/zaci/(?P<student_id>\d+)/change_qcard_ok/$', 'student_views.change_qcard_ok'),
    ...
    (r'^kurzy/(?P<course_id>\d+)/zaci/pdf_qrcmd_cards/$', 'student_views.qrcmd_cards'),
    ...
    (r'^qkarty/$', 'qcard_views.index'),
    (r'^qkarty/(?P<qcard_id>\d+)/del/$', 'qcard_views.delete'),
    (r'^qkarty/clear/$', 'qcard_views.clear_all'),
    (r'^qkarty/clear_all/$', 'qcard_views.clear_all_all'),
    (r'^qkarty/print/$', 'qcard_views.print_all'),
    ...
    (r'^import/(?P<file_id>\d+)/import_school/$', 'import_views.import_school'),
    (r'^import/(?P<file_id>\d+)/import_school/to/(?P<course_id>\d+)/$', 'import_views.import_school_do'),
 

    (r'^backup/$', 'backup_views.index'),
    (r'^backup/(?P<course_id>\d+)/do/$', 'backup_views.plan_backup'),
    (r'^backup/(?P<course_id>\d+)/dosync/$', 'backup_views.plan_fullsync'),
